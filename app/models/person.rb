class Person < ActiveRecord::Base
  ...
  RELATIONSHIPS = ["grandmother", "son", "daughter", "father", "mother", "wife", "husband", "daughter_in_law", "son_in_law", "father_in_law", "mother_in_law", "grandfather", "grandson", "granddaughter", "brother", "sister"]
