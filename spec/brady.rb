module Brady
  def make_brady_bunch
    ...
    @robert  = create(:person, first_name: "Robert", last_name: "Brady", gender: "M")
        @robert.confirmed_at = Time.now
    ...
    @mike    = create(:person, first_name: "Mike", father_id: @robert.id, gender: "M")
        @mike.confirmed_at = Time.now
    @rebekah = create(:person, first_name: "Rebekah", father_id: @robert.id, gender: "F")
        @rebekah.confirmed_at = Time.now
