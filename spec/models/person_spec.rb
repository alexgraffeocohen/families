...
describe Person do
  ...
  it "can return current relationships" do
    relations = ["brother", "sister", "brother", "brother", "sister", "mother", "father", "maternal grandmother", "maternal grandfather", "maternal aunt", "maternal uncle", "cousin", "paternal grandfather", "paternal aunt"]
